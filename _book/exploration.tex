...
\StringTok{  }\KeywordTok{count}\NormalTok{(maritl,}
        ...
        \DataTypeTok{name =} \StringTok{"Sum"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tab \textless{}{-}}\StringTok{ }\KeywordTok{table}\NormalTok{(wage\_df}\OperatorTok{$}\NormalTok{jobclass, wage\_df}\OperatorTok{$}\NormalTok{race)}
\NormalTok{tab}
\end{Highlighting}
\end{Shaded}
